    ...
    public void UpdateStage() {
            ...
            foreach (StageChange change in currentStage) {
                ...
                switch (change.target) {
                    ...
                    case "dialogue":
                        ...
                        break;
                    default:
                        Debug.Log("Character is: " + change.target + " feeling " + change.emotion);
        ...
        if (characters.Count != 0 && slots.Length != 0)
            foreach (var (character, i) in characters.WithIndex()) {
                ...
                slots[i].sprite = imgLdr.Load(new string[] { "Assets", "Media", "characters", character.target, character.emotion + ".png" });
            }
    }
